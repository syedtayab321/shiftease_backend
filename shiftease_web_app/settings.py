"""
Django settings for shiftease_web_app project.
...
SECRET_KEY = 'django-insecure-xh&9q@axu)b^9dcv*g@j6^6hr(&q*+#u7pp9o%tj6+e*$mman6'
...
ROOT_URLCONF = 'shiftease_web_app.urls'
...
WSGI_APPLICATION = 'shiftease_web_app.wsgi.application'
